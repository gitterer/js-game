const imageDynamic = "render/js/player.png";
const imageStatic = "render/js/sprites_big.png";
...
xStaticSpriteSize =80;
yStaticSpriteSize =25;
canvas.renderCoin(imageStatic, xStaticSpriteSize, yStaticSpriteSize, 1, 150 ,  AdjustImage,1);
canvas.renderCoin(imageStatic, xStaticSpriteSize, yStaticSpriteSize, 1, 300 ,  AdjustImage,1);
canvas.renderCoin(imageStatic, xStaticSpriteSize, yStaticSpriteSize, 1, 490 ,  AdjustImage,1);
canvas.renderCoin(imageStatic, xStaticSpriteSize, yStaticSpriteSize, 1, 750 ,  AdjustImage,1);
canvas.renderCoin(imageStatic, xStaticSpriteSize, yStaticSpriteSize, 1, 650 ,  AdjustImage,1);
canvas.renderCoin(imageStatic, xStaticSpriteSize, yStaticSpriteSize, 1, 950 ,  AdjustImage,1); 
canvas.start();
